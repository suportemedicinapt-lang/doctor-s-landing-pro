...
// Seção Final com CTA
const FinalCTA = () => {
  const whatsappLink = `https://wa.me/${doctorData.whatsapp.replace(/\D/g, '')}?text=Olá, gostaria de agendar uma consulta com Dr(a). ${doctorData.nome}.`;
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-gradient-card rounded-3xl p-8 md:p-12 border shadow-xl text-center animate-scale-in">
            ...
            <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
              Estou aqui para ajudar você a cuidar da sua {doctorData.especialidade.toLowerCase()}. 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <Button
                ...
                asChild
              >
                <a href={`tel:${doctorData.telefone.replace(/\D/g, '')}`}>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-muted-foreground">
              Dr(a). {doctorData.nome} • {doctorData.especialidade}
            </p>
          </div>
        </div>
      </div>
